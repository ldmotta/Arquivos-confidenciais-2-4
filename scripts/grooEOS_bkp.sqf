...
_SquadRanks 		=[];
_squadSkills		=[0.6,0.8];

_Platoon 	=[
			
			/*Defensive*/		["CAF_AG_ME_AK47","CAF_AG_ME_AK47","CAF_AG_ME_RPG","CAF_AG_ME_RPG","CAF_AG_ME_PK","CAF_AG_ME_PK"],
			/*Patrolling*/		["CAF_AG_ME_AK74","CAF_AG_ME_AK47","CAF_AG_ME_AK47","CAF_AG_ME_RPG","CAF_AG_ME_RPG","CAF_AG_ME_PK","CAF_AG_ME_PK"],
			/*Offensive*/		["CAF_AG_ME_AK74","CAF_AG_ME_AK47","CAF_AG_ME_AK47","CAF_AG_ME_RPG","CAF_AG_ME_AK74","CAF_AG_ME_AK74"]
...
_Snipers		=["CAF_AG_ME_T_RPG","CAF_AG_ME_T_SVD"];
_SniperRanks = [];
